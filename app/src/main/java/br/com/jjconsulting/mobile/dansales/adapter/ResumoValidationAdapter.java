...
public class ResumoValidationAdapter extends RecyclerView.Adapter<ResumoValidationAdapter.ViewHolder> {
    ...
    public ResumoValidationAdapter(Context context, ValidationDan validation) {
        mContext = context;
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        switch (viewType) {
            case ITEM:
                view = inflater.inflate(R.layout.item_resumo_validation, parent,
                        false);
                view.setId(viewType);
                break;
            case LOADING:
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView) {
            super(itemView);
            mDescricaoErroTextView = itemView.findViewById(R.id.item_resumo_descricao_text_view);
            mIconImageView = itemView.findViewById(R.id.item_resumo_icon_image_view);
        }
    }
