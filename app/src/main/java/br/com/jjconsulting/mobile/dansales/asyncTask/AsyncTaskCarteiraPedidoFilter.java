...
public class AsyncTaskCarteiraPedidoFilter extends AsyncTask<String, Void, Object[]> {
    ...
    public AsyncTaskCarteiraPedidoFilter(Context context, boolean isStartLoading,
    ...
    protected Object[] doInBackground(String... params) {
        ...
        switch (type) {
            ...
            case BANDEIRA:
                ...
                break;
            case STATUS:
                RelatorioCarteiraPedidoDao relatorioCarteiraPedidoDao = new RelatorioCarteiraPedidoDao(context);
                //List<StatusPedido> statuses = relatorioCarteiraPedidoDao.getStatusPedido();
                ArrayList<StatusPedido> status = relatorioCarteiraPedidoDao.getCarteiraPedidoStatus();
                objects = SpinnerArrayAdapter.makeObjectsWithHint(status.toArray(),
